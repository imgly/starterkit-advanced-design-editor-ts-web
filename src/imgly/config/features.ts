...
export function setupFeatures(cesdk: CreativeEditorSDK): void {
  cesdk.feature.enable([
    ...
    'ly.img.text.advanced' /* Advanced text controls (line height, letter spacing, etc.) */,
    ...
    'ly.img.canvas.menu' /* Canvas Menu visibility (right-click context menu) */,
    // #endregion
    ...
    // 'ly.img.inspector.bar' /* Inspector Bar visibility (contextual toolbar) */,
