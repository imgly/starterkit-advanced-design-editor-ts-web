...
For complete integration guides and API reference, visit the [Advanced Design Editor Documentation](https://img.ly/docs/cesdk/js/starterkits/advanced-editor-87riel/).
